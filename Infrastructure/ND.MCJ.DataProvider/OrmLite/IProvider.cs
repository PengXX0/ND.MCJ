...
namespace ND.MCJ.DataProvider.OrmLite
{
    public interface IProvider
    {
        ...
        T Delete<T>(T entity) where T : BaseModel, new();
        ...
        PagedList<T> FindAllByPage<T>(String selectBody, String selectTable, String sortBody, String whereBody, int pageIndex, int pageSize, bool isDesc, String groupBody = "") where T : BaseModel, new();
    }
}
