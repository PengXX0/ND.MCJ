var doc = {
    ...
    submitForm: function (obj) {
        ...
        $.ajax({
            ...
            success: function (response) { $("input[name='response']").val(response.Response); doc.formatJson(response.Response); $("input[name='sign']").val(response.Sign); },
    ...
    init: function () {
        ...
        if ($("input[name='response']")) { this.formatJson($("input[name='response']").val()); }
    }
};
$(function () { doc.init(); });